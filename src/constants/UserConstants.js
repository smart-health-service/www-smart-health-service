...
export const START_GET_DOC_LIST = "START_GET_DOC_LIST";
export const SUCCESS_GET_DOC_LIST = "SUCCESS_GET_DOC_LIST";
export const ERROR_GET_DOC_LIST = "START_GET_DOC_LIST";
